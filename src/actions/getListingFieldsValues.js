    ...
    try {
      ...
      if (!data && !data.getListingSettings) {
        ...
        if (step === "2" && !step2DataIsLoaded) {
          ...
          let updatedValuesStep3 = Object.assign({}, listingFieldsValues, { id: listId }, { currency: baseCurrency }, { bookingType: 'instant' }, { maxDaysNotice: 'available' }, { minDay: 0 }, { maxDay: 0 });
