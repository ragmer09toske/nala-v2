...
export const PortCv = ({setProfileState, profileState}) => {
  ...
  return (
    <>
        <PortCvBottomsheet isOpen={isBottomSheetOpen} onClose={closeBottomSheet} />
        <CVUpload isOpen={cvIsOpen} onClose={setCvIsOpen}/>
        <Box
          sx={{
            pl: 2,
            pr: 2,
        ...
        >
          ...
          <IconButton color="primary" aria-label="add" sx={{mt: -1}}>
            {aboutCurrentUserPortfolio ? (<Brush onClick={()=>setIsBottomSheetOpen(true)}/>) : (<Add onClick={()=>setIsBottomSheetOpen(true)}/>)}
          </IconButton>
        </Box>
        ...
        >
          ...
          <IconButton color="primary" aria-label="add" sx={{mt: -1}}>
              <Brush onClick={()=>setCvIsOpen(true)} />
          </IconButton>
        </Box>
        {seeCV && (<Box sx={{
            pl: 2,
        ...
        >
          <Icon style={{ color: "#1a73e8" }}>attach_file</Icon>
