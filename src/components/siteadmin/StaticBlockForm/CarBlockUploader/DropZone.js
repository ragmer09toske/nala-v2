...
import { startStaticImage2Loader, doUploadStaticImage, stopStaticImageLoader } from '../../../../actions/siteadmin/manageStaticBlock';
...
class Dropzone extends Component {
    ...
    addedfile(file, fromServer) {
        const { startStaticImageLoader, stopStaticImageLoader, startStaticImage2Loader } = this.props;
