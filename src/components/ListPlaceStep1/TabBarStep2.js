  ...
  render() {
    ...
    return (
      <div className={cx(s.progressContainer, 'hidden-xs')}>
        <div className={cx(s.textTrunck, s.progressSection, partionClass,
          { [s.active]: pathname === "photos" })} title={formatMessage(messages.photos)}>
        ...
        </div>
        {
          ...
          <div className={cx(s.textTrunck, s.progressSection, partionClass,
            { [s.active]: pathname === "cover-photo" })} title={formatMessage(messages.setCover)}>
        ...
        <div className={cx(s.textTrunck, s.progressSection, partionClass,
          { [s.active]: pathname === "description" })} title={formatMessage(messages.tabDescription)}>
        ...
        <div className={cx(s.textTrunck, s.progressSection, partionClass,
          { [s.active]: pathname === "title" })} title={formatMessage(messages.tabTitle)}>
