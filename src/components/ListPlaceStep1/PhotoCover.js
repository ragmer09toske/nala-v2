                        ...
                        listPhotos && listPhotos.map((option, index) => (
                          <div className={cx('col-lg-6 col-md-6 col-sm-6 col-xs-12')} key={index}>
                            <div className={s.listPhotoCover}>
                              ...
                              <div className={cx(s.coverPhotoSelection, 'coverPhotoSelectionRTL')}>
                                <Field
               ...
               <div className={s.nextBackButton}>
                ...
                <FormGroup className={s.formGroup}>
                  <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                    <Button className={cx(s.button, s.btnPrimaryBorder, s.btnlarge, s.pullLeft, 'floatRightRTL')} onClick={() => previousPage("photos")}>
                      <FormattedMessage {...messages.back} />
                    </Button>
                    <Button className={cx(s.button, s.btnPrimary, s.btnlarge, s.pullRight, 'floatLeftRTL')} onClick={() => nextPage("description")}>
