...
const BottomSheet = ({ isOpen, onClose, bioValue }) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{pt:2}}>
        <Box sx={{pl:2, pr:2}}>
          <h6>Bio</h6>
          <p style={{ fontSize: "13px", color:"rgba(0, 0, 0, 0.779)"}}>Make you bio simple, straight and short</p>
          <p  style={{ fontSize: "13px", color:"rgba(0, 0, 0, 0.779)"}}>
          (e.g. 🌟 Passionate Creator | 🎨 Graphic Designer | ✨ Explorer | Helping brands shine! ✨ Let's collaborate! 💌 #DesignMagic)
          </p>
        </Box>
        <Box sx={{pl:2, pr: 4}}>
